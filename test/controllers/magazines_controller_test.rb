...
class MagazinesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create magazine" do
    assert_difference('Magazine.count') do
      post magazines_url, params: { magazine: { isbn: @magazine.isbn, published_at: @magazine.published_at, title: @magazine.title } }
    end
  ...
  test "should update magazine" do
    patch magazine_url(@magazine), params: { magazine: { isbn: @magazine.isbn, published_at: @magazine.published_at, title: @magazine.title } }
